...
export const motionRecipeRegistry: Record<MotionRecipeId, MotionRecipe> = {
  'standard-scene-motion': {
    ...
    fixture: { project: 'examples/motion-registry/project.json', sceneId: 'overview' },
  ...
  'text-blur-slide': {
    ...
    lifecycle: ['anticipation', 'action', 'settle', 'hold'], fixture: { project: 'examples/motion-registry/project.json', sceneId: 'opening' },
  ...
  'chapter-demote-to-label': {
    ...
    lifecycle: ['anticipation', 'action', 'settle', 'hold'], fixture: { project: 'examples/motion-registry/project.json', sceneId: 'chapter' },
  ...
  'focus-scan-lock': {
    ...
    lifecycle: ['anticipation', 'action', 'settle', 'hold'], fixture: { project: 'examples/motion-registry/project.json', sceneId: 'focus' },
  ...
  'outro-strip-away': {
    ...
    lifecycle: ['anticipation', 'action', 'settle', 'hold'], fixture: { project: 'examples/motion-registry/project.json', sceneId: 'closing' },
